...
\begin{document}
%\nocite{*} % FORCES ALL 18 ENTRIES TO PRINT FOR TESTING PURPOSES
...
\appendix % Activates appendix formatting rules
\addchap{Appendix} % Creates an unnumbered Appendix heading in the TOC
\thispagestyle{plain}
