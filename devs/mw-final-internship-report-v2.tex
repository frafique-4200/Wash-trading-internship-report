...
\begin{itemize}
    ...
    \item \textbf{Source Code:} The complete graph analysis implementation script repository is hosted on the \href{https://hs-mittweida.de}{HSMW GitLab} and \href{https://hs-mittweida.de}{here}
\end{itemize}
